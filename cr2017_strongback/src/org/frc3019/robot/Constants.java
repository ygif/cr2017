...
public class Constants {
	...
	//PWMS
		...
		public static final int RIGHT_FRONT_MOTOR_PWM = 2;
		public static final int RIGHT_REAR_MOTOR_PWM = 3;
		
		//MOTOR-DRIVEN SUBSYSTEM PWMS
		public static final int SHOOTER_MOTOR_PWM = 4;
		public static final int AGITATOR_MOTOR_PWM = 5;
		public static final int PICKUP_MOTOR_PWM = 6;
		public static final int CLIMBER_MOTOR_PWM = 7;
